...
const codeExamples: Record<Language, string> = {
  "cURL": `curl -X DELETE 'https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments/ec8d751d-c7a4-4e10-a122-29ac1488b0cc' \\
...
const RemoveContactSegment = () => {
  ...
  return (
    <main className="flex max-w-[1600px] mx-auto px-6">
      <ApiSidebar activePath="/api/remove-contact-segment" />

      <div className="flex-1 min-w-0 px-12 py-8">
        <div className="text-sm text-muted-foreground mb-4">Contacts</div>

        <div className="flex items-start justify-between mb-4">
          <h1 className="text-3xl font-bold text-foreground">Remove Contact Segment</h1>
          <CopyPageDropdown />
        </div>
        ...
        <div className="mb-8">
          <Endpoint method="DELETE" url="https://api.monosend.io/contacts/{contact_id}/segments/{segment_id}" />
        </div>
        ...
        <div className="divide-border border-border">
          ...
          <Parameter
            ...
            type="string"
            required
            description="Segment UUID to remove the contact from."
          />
        </div>
...
export default RemoveContactSegment;
