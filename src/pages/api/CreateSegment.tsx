...
const codeExamples: Record<Language, string> = {
  "cURL": `curl -X POST 'https://api.monosend.io/segments' \\
...
public class Main {
  public static void main(String[] args) throws Exception {
    String payload = "{\"name\":\"VIP customers\"}";
...
var request = new HttpRequestMessage(HttpMethod.Post, "https://api.monosend.io/segments");
...
$ch = curl_init("https://api.monosend.io/segments");
...
const CreateSegment = () => {
  ...
  return (
    <main className="flex max-w-[1600px] mx-auto px-6">
      <ApiSidebar activePath="/api/create-segment" />
      ...
      <div className="flex-1 min-w-0 px-12 py-8">
        ...
        <p className="text-muted-foreground mb-6">
          Create a new segment to group contacts for targeted outreach.
        </p>

        <div className="mb-8">
          <Endpoint method="POST" url="https://api.monosend.io/segments" />
        </div>
