...
const GetSegment = () => {
  ...
  return (
    <main className="flex max-w-[1600px] mx-auto px-6">
      <ApiSidebar activePath="/api/get-segment" />

      <div className="flex-1 min-w-0 px-12 py-8">
        <div className="text-sm text-muted-foreground mb-4">Segments</div>

        <div className="flex items-start justify-between mb-4">
          <h1 className="text-3xl font-bold text-foreground">Get Segment</h1>
          <CopyPageDropdown />
        </div>

        <p className="text-muted-foreground mb-6">
          Retrieve a segment and its metadata by segment ID.
        </p>

        <div className="mb-8">
          <Endpoint method="GET" url="https://api.monosend.io/segments/{segment_id}" />
        </div>
