...
const codeExamples: Record<Language, string> = {
  "cURL": `curl -X PATCH 'https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e' \\
...
public class Main {
  public static void main(String[] args) throws Exception {
    String payload = "{\"first_name\":\"Mark\",\"last_name\":\"Tsunberg\",\"properties\":{\"department\":\"RND\"}}";
...
var payload = new StringContent(
  "{\"first_name\":\"Mark\",\"last_name\":\"Tsunberg\",\"properties\":{\"department\":\"RND\"}}",
  Encoding.UTF8,
  "application/json"
);
...
$ch = curl_init("https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e");
...
const UpdateContact = () => {
  ...
  return (
    <main className="flex max-w-[1600px] mx-auto px-6">
      <ApiSidebar activePath="/api/update-contact" />

      <div className="flex-1 min-w-0 px-12 py-8">
        <div className="text-sm text-muted-foreground mb-4">Contacts</div>

        <div className="flex items-start justify-between mb-4">
          <h1 className="text-3xl font-bold text-foreground">Update Contact</h1>
          <CopyPageDropdown />
        </div>

        <p className="text-muted-foreground mb-6">
          Update a contact's profile details or custom properties.
        </p>

        <div className="mb-8">
          <Endpoint method="PATCH" url="https://api.monosend.io/contacts/{contact_id}" />
        </div>
        ...
        <div className="divide-border border-border">
          ...
          <Parameter
            name="properties"
            type="object"
            description="Custom properties to merge into the contact profile."
          />
        </div>
