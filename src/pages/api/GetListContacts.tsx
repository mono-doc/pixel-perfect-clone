...
const codeExamples: Record<Language, string> = {
  "cURL": `curl -X GET 'https://api.monosend.io/contacts' \\
...
var request = new HttpRequestMessage(
  HttpMethod.Get,
  "https://api.monosend.io/contacts"
);
...
Console.WriteLine(body);`,
  "PHP": `$ch = curl_init("https://api.monosend.io/contacts");
...
const GetListContacts = () => {
  ...
  return (
    <main className="flex max-w-[1600px] mx-auto px-6">
      <ApiSidebar activePath="/api/get-list-contacts" />

      <div className="flex-1 min-w-0 px-12 py-8">
        <div className="text-sm text-muted-foreground mb-4">Contacts</div>

        <div className="flex items-start justify-between mb-4">
          <h1 className="text-3xl font-bold text-foreground">Get List Contacts</h1>
          <CopyPageDropdown />
        </div>

        <p className="text-muted-foreground mb-6">
          Return the list of contacts in your account.
        </p>

        <div className="mb-8">
          <Endpoint method="GET" url="https://api.monosend.io/contacts" />
        </div>

        <h2 className="text-xl font-semibold text-foreground mb-4">Path Parameters</h2>
        <p className="text-muted-foreground text-sm mb-6">No path parameters are required for this endpoint.</p>
      ...
      <aside className="max-w-md flex-shrink-0 py-8 sticky top-24 h-fit">
        ...
        <div className="mt-4">
          <CodeBlock
            title="Response"
            code={`{
  "next_cursor": "294e3bfc-e8f8-4b51-a1f1-d71872b8db4e",
  "data": [
    {
    ...
    {
      "id": "890e3bfc-e8f8-4b51-a1f1-d71872b8db4f",
      "email": "jane.doe@gmail.com",
      "first_name": "Jane",
      "last_name": "Doe",
      "created_at": "2024-05-12T09:20:10.123456+00:00",
      "unsubscribed": false
    }
  ]
}`}
