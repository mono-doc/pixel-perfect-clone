...
const codeExamples: Record<Language, string> = {
  "cURL": `curl -X POST 'https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments/ec8d751d-c7a4-4e10-a122-29ac1488b0cc' \\
  -H 'Authorization: Bearer mono_xxxxx' \\
  -H 'Content-Type: application/json'`,
  "Python": `import requests

url = "https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments/ec8d751d-c7a4-4e10-a122-29ac1488b0cc"
headers = {
...
print(response.json())`,
  ...
  "https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments/ec8d751d-c7a4-4e10-a122-29ac1488b0cc",
  {
    method: "POST",
    headers: {
      Authorization: "Bearer mono_xxxxx",
...
public class Main {
  public static void main(String[] args) throws Exception {
    HttpRequest request = HttpRequest.newBuilder()
      .uri(URI.create("https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments/ec8d751d-c7a4-4e10-a122-29ac1488b0cc"))
...
Console.WriteLine(body);`,
  "PHP": `$ch = curl_init("https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments/ec8d751d-c7a4-4e10-a122-29ac1488b0cc");
...
const AddContactToSegment = () => {
  ...
  return (
    <main className="flex max-w-[1600px] mx-auto px-6">
      <ApiSidebar activePath="/api/add-contact-to-segment" />

      <div className="flex-1 min-w-0 px-12 py-8">
        <div className="text-sm text-muted-foreground mb-4">Contacts</div>

        <div className="flex items-start justify-between mb-4">
          <h1 className="text-3xl font-bold text-foreground">Add Contact to Segment</h1>
          <CopyPageDropdown />
        </div>

        <p className="text-muted-foreground mb-6">
          Add a contact to a segment using the contact and segment identifiers.
        </p>

        <div className="mb-8">
          <Endpoint method="POST" url="https://api.monosend.io/contacts/{contact_id}/segments/{segment_id}" />
        </div>

        <h2 className="text-xl font-semibold text-foreground mb-4">Body Parameters</h2>
        <p className="text-muted-foreground text-sm mb-6">No body parameters are required for this endpoint.</p>
