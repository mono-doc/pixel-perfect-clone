...
const codeExamples: Record<Language, string> = {
  "cURL": `curl -X GET 'https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments' \\
  -H 'Authorization: Bearer mono_xxxxx'`,
  "Python": `import requests

url = "https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments"
headers = {
...
print(response.json())`,
  ...
  "https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments",
  {
    method: "GET",
    headers: {
      Authorization: "Bearer mono_xxxxx"
...
public class Main {
  public static void main(String[] args) throws Exception {
    HttpRequest request = HttpRequest.newBuilder()
      .uri(URI.create("https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments"))
...
Console.WriteLine(body);`,
  "PHP": `$ch = curl_init("https://api.monosend.io/contacts/294e3bfc-e8f8-4b51-a1f1-d71872b8db4e/segments");
...
const GetContactSegments = () => {
  ...
  return (
    <main className="flex max-w-[1600px] mx-auto px-6">
      <ApiSidebar activePath="/api/get-contact-segments" />

      <div className="flex-1 min-w-0 px-12 py-8">
        <div className="text-sm text-muted-foreground mb-4">Contacts</div>

        <div className="flex items-start justify-between mb-4">
          <h1 className="text-3xl font-bold text-foreground">Get Contact Segments</h1>
          <CopyPageDropdown />
        </div>

        <p className="text-muted-foreground mb-6">
          List segments that contain the specified contact.
        </p>

        <div className="mb-8">
          <Endpoint method="GET" url="https://api.monosend.io/contacts/{contact_id}/segments" />
        </div>
