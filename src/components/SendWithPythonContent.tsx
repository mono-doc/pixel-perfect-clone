...
const SendWithPythonContent = () => {
  return (
    <main className="flex-1 min-w-0 py-8 px-12">
      <div className="mb-4">
        <span className="text-xs font-semibold text-primary uppercase tracking-wider">Python</span>
      </div>

      <div className="flex items-start justify-between mb-6">
        <h1 className="text-3xl sm:text-4xl font-semibold text-foreground">Send emails with Python</h1>
        <CopyPageDropdown />
      </div>
...
print(email)`}</code>
      ...
      <section id="3-try-it-yourself" className="mt-10 scroll-mt-32">
        ...
        <a
          href="https://github.com/resend/resend-python-example"
          className="block rounded-xl border border-border p-4 hover:bg-muted transition-colors"
        >
          <h3 className="text-base font-semibold text-foreground mb-1">Python Example</h3>
...
export default SendWithPythonContent;
